...
class Capturer(object):
    def __init__(self, play):
        ...
        self.out = cv2.VideoWriter('output.avi', cv2.VideoWriter_fourcc(*'XVID'), 20, (self.image_width * 4, self.image_height * 2))
    ...
    def capture(self):
        ...
        camera_bp.set_attribute('image_size_x', str(self.image_width))
        camera_bp.set_attribute('image_size_y', str(self.image_height*2))
        cameraT = world.spawn_actor(camera_bp, camera_top_trans, attach_to=self.player)
